...
export const SCENES: SceneMetadata[] = [
  ...
  },
  {
    ...
    thumbnailUrl: `${STORAGE_BASE}/marmorljus-new.jpg`,
    fullResUrl: `${STORAGE_BASE}/marmorljus-new.jpg`,
    horizonY: 52,
    baselineY: 70,
    defaultScale: 0.65,
    shadowPreset: {
  ...
  },
  {
    ...
    thumbnailUrl: `${STORAGE_BASE}/vit-kakel-new.jpg`,
    fullResUrl: `${STORAGE_BASE}/vit-kakel-new.jpg`,
    horizonY: 55,
    baselineY: 75,
    defaultScale: 0.65,
    shadowPreset: {
