    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
          ...
          <span className="text-sm font-medium text-primary">AI-driven bildkomposition</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
          Byt bakgrund, lägg till skuggor och reflektioner automatiskt. 
          Konsekvent resultat för alla dina bilar, varje gång.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button 
            size="lg" 
            className="bg-gradient-premium hover:opacity-90 transition-opacity shadow-premium text-base gap-2"
        ...
        <div className="mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-foreground mb-2">&lt;30s</div>
