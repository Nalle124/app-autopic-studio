  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "text-white shadow-glow hover:shadow-[0_0_30px_hsl(var(--primary)/0.5)] rounded-button relative overflow-hidden bg-gradient-to-b from-[hsl(0_38%_40%)] to-[hsl(0_38%_28%)] hover:from-[hsl(0_38%_45%)] hover:to-[hsl(0_38%_32%)] before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/12 before:to-transparent before:pointer-events-none opacity-90 hover:opacity-100",
      },
      size: {
